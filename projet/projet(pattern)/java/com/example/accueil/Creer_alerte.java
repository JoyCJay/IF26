...
public class Creer_alerte extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case Menu.FIRST +1:
                Intent i1 = new Intent(Creer_alerte.this, MainActivity.class);
                startActivity(i1);
                break;
            case Menu.FIRST +2:
                break;
            ...
            case Menu.FIRST +4:
                break;
            case Menu.FIRST +5:
                Intent i5 = new Intent(Creer_alerte.this, Notification.class);
                startActivity(i5);
                break;
            case Menu.FIRST +6:
                break;
            case Menu.FIRST +7:
                Intent i2 = new Intent(Creer_alerte.this, Alerte_stage.class);
                startActivity(i2);
                break;
            case Menu.FIRST +8:
                Intent i3 = new Intent(Creer_alerte.this, Soiree.class);
                startActivity(i3);
                break;
            case Menu.FIRST +9:
                Intent i4 = new Intent(Creer_alerte.this, Creer_alerte.class);
                startActivity(i4);
                break;
            case Menu.FIRST +10:
                break;
