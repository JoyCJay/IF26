...
public class Alerte_stage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alerte_stage);
        Toolbar mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setTitle("");
        setSupportActionBar(mToolbar);
        mtvTitle = (TextView) findViewById(R.id.toolbar_title);
        mtvTitle.setText("Alerte Stage");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case Menu.FIRST +1:
                Intent i1 = new Intent(Alerte_stage.this, MainActivity.class);
                startActivity(i1);
                break;
            case Menu.FIRST +2:
                break;
            ...
            case Menu.FIRST +4:
                break;
            case Menu.FIRST +5:
                Intent i5 = new Intent(Alerte_stage.this, Notification.class);
                startActivity(i5);
                break;
            case Menu.FIRST +6:
                break;
            case Menu.FIRST +7:
                Intent i2 = new Intent(Alerte_stage.this, Alerte_stage.class);
                startActivity(i2);
                break;
            case Menu.FIRST +8:
                Intent i3 = new Intent(Alerte_stage.this, Soiree.class);
                startActivity(i3);
                break;
            case Menu.FIRST +9:
                Intent i4 = new Intent(Alerte_stage.this, Creer_alerte.class);
                startActivity(i4);
                break;
            case Menu.FIRST +10:
                break;
