    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case Menu.FIRST +6:
                break;
            case Menu.FIRST +7:
                Intent i2 = new Intent(MainActivity.this, Alerte_stage.class);
                startActivity(i2);
                break;
            case Menu.FIRST +8:
                Intent i3 = new Intent(MainActivity.this, Soiree.class);
                startActivity(i3);
                break;
            case Menu.FIRST +9:
                Intent i4 = new Intent(MainActivity.this, Creer_alerte.class);
                startActivity(i4);
                break;
            case Menu.FIRST +10:
                break;
